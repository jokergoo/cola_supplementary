...
For row $i$ in a matrix $\mathbf{M}$, $\mathbf{x}$ is a vector of _the absolute
correlation_ to all other rows, the ATC (ability to correlate to other rows)
...
```{r, echo = FALSE, fig.width = 5, fig.height = 5, fig.align = "center", fig.cap = "Figure 1. Demonstration of ATC score"}
par(mar = c(4, 4, 1, 1))

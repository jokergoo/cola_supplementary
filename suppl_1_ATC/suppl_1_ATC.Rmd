...
```{r, echo = FALSE, fig.width = 14, fig.height = 14/4, fig.align = "center", fig.cap = "Figure 1.2. A simulation test with three groups of rows with different correlation structures."}
set.seed(12345)
